...
#define NO_OF_DECKS 1
#define NO_OF_SUITS 4
#define NO_OF_CARD_VALUES 13
#define NO_OF_EXTRA_CARDS 0
#define HI_LO_ACES 1/* Can aces be both hi or lo? 1 = yes; 0 = no */
#define NO_OF_CARDS (NO_OF_DECKS * ((NO_OF_CARD_VALUES * NO_OF_SUITS) + NO_OF_EXTRA_CARDS))
